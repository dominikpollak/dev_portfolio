...
export default function MyProjects() {
    ...
    return (
            <div className='flex flex-col items-center' onClick={handleMyprojects}>
                ...
                <div className={myprojects ? 'flex items-center justify-center px-2 text-white bg-black break-words m-0 p-0' : ' flex items-center justify-center px-2 text-center bg-white break-words m-0 p-0'}>
